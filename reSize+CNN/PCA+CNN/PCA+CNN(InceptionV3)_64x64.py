...
# 차원축소 데이터 저장 경로 지정
npyResDir = "./pca_npyRes/pca_cnn_I_64/"
...
# 학습된 가중치 모델 저장
if choice == "1":
    model_path = os.path.join(npyResDir, "classification_inceptiont_64x64_dogcat.h5")
    model.save(model_path)
elif choice == "3":
    model_path = os.path.join(npyResDir, "classification_inceptiont_64x64_FEB2013.h5")
    model.save(model_path)
...
print("\n\n" + "=" * 60)
print("--- Model result ---")
print("* PCA + CNN / MobileNet / Size(64x64)")
print("="*60)
