...
# 차원축소 데이터 저장 경로 지정
npyResDir = "./auto_npyRes/auto_cnn_M_64/"
...
if choice == "1":
    ae_path = os.path.join(npyResDir, "autoencoder_mobilenet_64x64_dogcat.h5")
    model_path = os.path.join(npyResDir, "Classification_mobilenet_64x64_dogcat.h5")
elif choice == "3":
    ae_path = os.path.join(npyResDir, "autoencoder_mobilenet_64x64_FEB2013.h5")
