# Autoencoder + CNN (InceptionV3) 32x32
...
# AutoEncoder 저장
ae_path = os.path.join("", "autoencoder_inception_32x32_dogcat.h5")
autoencoder.save(ae_path)
print("AutoEncoder saved.")

# 분류 모델 저장
model_path = os.path.join("", "Classification_inception_32x32_dogcat.h5")
...
print("\n\n" + "=" * 60)
print("--- Model result ---")
print("* AutoEncoder + CNN / InceptionV3 / Size(32x32)")
print("="*60)
