...
# 차원축소 데이터 저장 경로 지정
npyResDir = "./auto_npyRes/auto_cnn_I_22/"
...
# Autoencoder 모델 구성
encoded_dim = (22, 22)  # Autoencoder의 압축 크기
...
if choice == "1":
    ae_path = os.path.join(npyResDir, "autoencoder_inception_22x22_dogcat.h5")
    model_path = os.path.join(npyResDir, "Classification_inception_22x22_dogcat.h5")
elif choice == "2":
    ae_path = os.path.join(npyResDir, "autoencoder_inception_22x22_FEB2013.h5")
    model_path = os.path.join(npyResDir, "Classification_inception_22x22_FEB2013.h5")
...
print("\n\n" + "=" * 60)
print("--- Model result ---")
print("* AutoEncoder + CNN / InceptionV3 / Size(22x22)")
print("="*60)
