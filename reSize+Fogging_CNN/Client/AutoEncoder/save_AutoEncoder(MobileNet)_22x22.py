...
if choice == "1":
    ae_path = os.path.join(npyResDir, "fog_autoencoder_mobilenet_22x22_dogcat.h5")
elif choice == "2":
    ae_path = os.path.join(npyResDir, "fog_autoencoder_mobilenet_22x22_FEB2013.h5")
...
# 시간 산정
print("\n\n" + "=" * 60)
print("--- Fogging + (save)AutoEncoder (MobileNet) | Size(22x22) TimeSet ---")
